...
function BrandCoffee() {
  ...
  return (
    <S.Article>
      ...
      <S.Divs>
        <img src={Coffeebean2} alt="coffeeBean2" />
        <div>
          <h3>"고품질을 위한, 고지대를 향한”</h3>
          <p>
            고품질의 아라비카 원두는 고도가 높은 곳에서 재배됩니다. <br />큰 일교차로 당도가 높고
            밀도가 단단한 원두는 깊고 복합적인 풍미를 냅니다.
          </p>
        </div>
      </S.Divs>
      ...
      <S.Divs>
        <div>
          ...
          <p>
            비터스윗은 커피 농부들과 공정한 커피 거래를 하며, <br /> 커피 농가와 지역사회가 커피
            산업으로 지속 가능한 삶을 영위하도록 노력하고 있습니다.
          </p>
        </div>
        <img src={Coffeebean3} alt="coffeeBean3" />
      </S.Divs>

      <S.Divs>
        <img src={Coffeebean4} alt="coffeeBean4" />
        <div>
